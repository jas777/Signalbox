package com.jas777.signalbox.blocks.it;
...
public class BlockItDistantHead extends BaseSignal implements HasVariant {
    ...
    public BlockItDistantHead() {
        super("it_distant_head", Material.IRON);
        this.setDefaultState(this.getDefaultState().withProperty(ACTIVE, Boolean.TRUE).withProperty(SIGNAL_VARIANT, 0));
        setCreativeTab(SignalboxTabs.IT_CREATIVE_TAB);
    }
