...
public class BlockHuMainSignalHeadTop extends BaseSignalPart implements HasVariant {
    ...
    public BlockHuMainSignalHeadTop() {
        super("hu_main_head_top", Material.IRON);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        if (!(worldIn.getBlockState(pos.down()).getBlock() instanceof BlockHuMainSignalHeadBottom)) {
