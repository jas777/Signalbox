...
public class BlockPlSignal4ChambersHeadMiddleWhite extends BaseSignalPart implements HasVariant {
    ...
    public BlockPlSignal4ChambersHeadMiddleWhite() {
        super("pl_signal_4chambers_head_middle_white", Material.IRON);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        if (!(worldIn.getBlockState(pos.down()).getBlock() instanceof BlockPlSignal4ChambersHeadBottomWhite)) {
