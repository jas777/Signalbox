...
public class BlockPlSignal4ChambersHeadMiddleOrange extends BaseSignalPart implements HasVariant {
    ...
    public BlockPlSignal4ChambersHeadMiddleOrange() {
        super("pl_signal_4chambers_head_middle_orange", Material.IRON);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        if (!(worldIn.getBlockState(pos.down()).getBlock() instanceof BlockPlSignal4ChambersHeadBottomOrange)) {
