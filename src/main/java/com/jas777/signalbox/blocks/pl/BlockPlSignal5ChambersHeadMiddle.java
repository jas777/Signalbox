...
public class BlockPlSignal5ChambersHeadMiddle extends BaseSignalPart implements HasVariant {
    ...
    public BlockPlSignal5ChambersHeadMiddle() {
        super("pl_signal_5chambers_head_middle", Material.IRON);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        if (!(worldIn.getBlockState(pos.down()).getBlock() instanceof BlockPlSignal5ChambersHeadBottom)) {
