...
public class BlockPlSignal5ChambersHeadTop extends BaseSignalPart implements HasVariant {
    ...
    public BlockPlSignal5ChambersHeadTop() {
        super("pl_signal_5chambers_head_top", Material.IRON);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        if (!(worldIn.getBlockState(pos.down().down()).getBlock() instanceof BlockPlSignal5ChambersHeadBottom)) {
