...
public class BlockPlSignal1ChambersHead extends BaseSignal implements HasVariant {
    ...
    public BlockPlSignal1ChambersHead() {
        super("pl_signal_1chambers_head", Material.IRON);
